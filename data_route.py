...
os.environ["DB_CONNECTION_STRING"] = (
    "Driver={ODBC Driver 18 for SQL Server};Server=tcp:meowmeowmeow.database.windows.net,"
    "1433;Database=heartdb;Uid=meowmeow;Pwd=Ass101223;Encrypt=yes;TrustServerCertificate=no;Connection "
    "Timeout=30;")
